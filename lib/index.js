...
// TODO: add some unit tests and a TravisCI build
// - constructor (with args checks)
// - setupDdp creates a valid-looking ddpclient object?
// - e2e test, with minimal local meteor app?
// - pseudo-e2e test with a 1ms timeout?

function MeteorPing(args) {
  this.args = args;
  // FIXME: strictly check args here, it'll help someone
}
